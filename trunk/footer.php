...
<script>
    ...
    <a href="http://www.facebook.com/share.php?u='http://localhost/biowizard-html5/index.php'"
    onclick="return fbs_click()" target="_blank">
    <img src="http://www.newamericanfunding.com/Career/img/Facebook-Share-Logo.jpg" style="height:22px" />
</a>
&nbsp;
<script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script>

      <script src="https://apis.google.com/js/plusone.js"></script>
<g:plus action="share" annotation="bubble" style="margin-top:5px"></g:plus> &nbsp;
