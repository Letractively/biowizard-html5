function ProPro(){
	...
	for(i=0;i< document.getElementsByClassName("button").length;i++){
		...
		document.getElementsByClassName("button").item(i).style.background="-moz-linear-gradient(top, #3e779d, #65a9d7)";
		document.getElementsByClassName("button").item(i).style.background="-ms-linear-gradient(top, #3e779d, #65a9d7)";
		document.getElementsByClassName("button").item(i).style.background="-o-linear-gradient(top, #3e779d, #65a9d7)";
		}
		document.getElementById("Pp").style.background="#1b435e";
		document.getElementById("Pp").style.borderTop="#1b435e";	
	}
...
function DisPro(){
	...
	for(i=0;i< document.getElementsByClassName("button").length;i++){
		...
		document.getElementById("Dp").style.background="#1b435e";
		document.getElementById("Dp").style.borderTop="#1b435e";			
...
function GenGen(){
	...
	for(i=0;i< document.getElementsByClassName("button").length;i++){
		...
		document.getElementById("Gg").style.background="#1b435e";
		document.getElementById("Gg").style.borderTop="#1b435e";
...
function DisGen(){
	...
	for(i=0;i< document.getElementsByClassName("button").length;i++){
		...
		document.getElementById("Dg").style.background="#1b435e";
